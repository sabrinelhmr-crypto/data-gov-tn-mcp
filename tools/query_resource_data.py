...
# Types de colonnes considers comme numeriques (litteraux non quotes en SQL).
_NUMERIC_TYPES = {
    "int",
    "integer",
    "bigint",
...
async def query_resource_data(
    ...
    Args:
        ...
        filters: Filtres sous forme d'objets {column, operator, value}.
            Operateurs : eq, ne, gt, lt, gte, lte, in, contains.
    ...
    if needs_sql:
        ...
        if total > _LARGE_DATASET_ROWS:
            lines.append(
                ...
                "Interrogez par pages ou telecharger le fichier brutal."
            )
