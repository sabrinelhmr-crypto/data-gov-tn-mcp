...
_LABELS: dict[str, dict[str, str]] = {
    "fr": {
        ...
        "Aucune ressource attachée à ce dataset.": ("Aucune ressource attachée à ce dataset."),
        "Page": "Page",
        "par page": "par page",
        "Ressource": "Ressource",
        "Format": "Format",
    ...
    "en": {
        ...
        "Veuillez fournir un identifiant de dataset.": ("Please provide a dataset identifier."),
        "Veuillez fournir un identifiant de ressource.": ("Please provide a resource identifier."),
        "Veuillez fournir un identifiant de dataservice.": (
            "Please provide a data service identifier."
        ),
        "Erreur": "Error",
        "ressource(s) pour": "resource(s) for",
        "Aucune ressource attachée à ce dataset.": ("No resource attached to this dataset."),
        "Page": "Page",
        "par page": "per page",
        "Ressource": "Resource",
        "Format": "Format",
        ...
        "spec_fetch_error": ("Unable to fetch the specification of '{title}' ({url}): {error}"),
        "spec_too_large": (
    ...
    "ar": {
        ...
        "Veuillez fournir un identifiant de dataset.": ("يرجى تقديم معرّف مجموعة البيانات."),
        "Veuillez fournir un identifiant de ressource.": ("يرجى تقديم معرّف المورد."),
        "Veuillez fournir un identifiant de dataservice.": ("يرجى تقديم معرّف خدمة البيانات."),
        "Erreur": "خطأ",
        "ressource(s) pour": "مورد(موارد) لـ",
        "Aucune ressource attachée à ce dataset.": ("لا توجد موارد مرفقة بمجموعة البيانات هذه."),
        "Page": "الصفحة",
        "par page": "لكل صفحة",
        "Ressource": "المورد",
        "Format": "التنسيق",
        ...
        "spec_too_large": ("مواصفة OpenAPI لـ '{title}' كبيرة جداً (>2 ميجابايت)، تم رفض التنزيل."),
